...
$(document).ready(function(){
	var table = $("#iptables_rules").DataTable({
		"columns": [ 
	...
	//应该可以像下一个函数那样写点击事件
	$("#iptables_rules_paginate").click(function(e){
		//点击上下页和其它页时，去除全选效果
	...
	$("#iptables_rules tbody").on("click",".check_rule",function(){
		console.log("clicked");
		if ($(this).is(":checked"))
		{
